...
source_urls = [
    ...
    "https://raw.githubusercontent.com/frank11311/CTVLive/refs/heads/main/live.txt",
    ...
    "https://freetv.fun/test_channels_korea.txt",
